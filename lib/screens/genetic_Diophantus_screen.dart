...
import 'package:rts_mobile/algorithms/genetic_Diophantus.dart';
...
class _GeneticAlgorithmState extends State<GeneticAlgorithm> {
  final allControllers = List<TextEditingController>.generate(
            ...
            children: [
              ...
              Offstage(
                ...
                child: Padding(
                  ...
                  child:
                      Text(resultValue, style: TextStyle(color: Colors.orange)),
                ),
              ),
  ...
  Widget _buildElementQuation(int controllerIndex) => Container(
        width: 20,
        child: TextField(
